...
router.post(
  '/follow-request/:followerId',
  auth,
  UserFollowController.acceptFollowInvitation
);

router.delete(
  '/follow-request/:followerId',
  auth,
  UserFollowController.declineFollowInvitation
);
router.delete(
  '/:profileId/follow-request',
  auth,
  UserFollowController.cancelFollowInvitation
);
