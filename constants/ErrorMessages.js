module.exports = {
    ...
    DIRECT_THREAD_REQUEST: 'In direct chat can be only 2 users',
    ...
    FORGOT_PASSWORD_EMAIL: 'Please provide correct email',
    FOLLOW_APPROVED: 'You already follow this user',
    FOLLOW_PERMISSION: `You can't follow or unfollow your account`,
    FOLLOW_PENDING: 'You have already sent request to follow this user',
